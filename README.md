...
* [anytime-icp-stack](./anytime-stack/src/anytime-icp-stack) directory contains the main implementation
	* [anytime-icp-stack/src/laser_icp.cpp](.anytime-stack/anytime-icp/src/anytime-icp-stack/src/laser_icp.cpp) – Contains the main Anytime ICP Node with the shared memory interface
	* [anytime-icp-stack/src/anytime_stanley_controller.cpp](.anytime-stack/anytime-icp/src/anytime-icp-stack/src/anytime_stanley_controller.cpp) – Contains the main Anytime Stanley Controller Node with the shared memory interface

...
def generate_launch_description():
    joy_teleop_config = os.path.join(
        get_package_share_directory('pf_test'),
        'config',
        'joy_teleop.yaml'
    )
    ...
    ego_robot_publisher = Node(
        ...
        parameters=[{'robot_description': Command(['xacro ', os.path.join(get_package_share_directory('pf_test'), 'description', 'racecar.xacro')])}],
    ...
    map_server_node = Node(
        ...
        parameters=[{'yaml_filename': '/home/schmidd/ros_ws/src/pf_test/maps/savedMap.yaml'},
                    {'topic': 'map'},
                    {'frame_id': 'map'},
                    {'output': 'screen'},
                    {'use_sim_time': False}]
    ...
    rviz_node = Node(
        ...
        executable='rviz2',
        name='rviz',
        arguments=['-d', os.path.join(get_package_share_directory('pf_test'), 'description', 'rviz_launch.rviz')]
    )

...
def generate_launch_description():
    ...
    ld = LaunchDescription([joy_la, vesc_la, sensors_la, mux_la, localize_la])
    ...
    map_server_node = Node(
        ...
        parameters=[{'yaml_filename': '/home/f1tenth2/f1tenth_ros2_ws/src/f1tenth_cmu_stack_cpp/maps/map3.yaml'},
                    {'topic': 'map'},
                    {'frame_id': 'map'},
                    {'output': 'screen'},
                    {'use_sim_time': False}]
